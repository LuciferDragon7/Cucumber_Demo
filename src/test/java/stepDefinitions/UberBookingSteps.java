...
public class UberBookingSteps {
	...
	@When("User select car {string} and pick up location {string} and drop location {string}")
	public void user_select_car_and_pick_up_location_and_drop_location(String carType, String pickUpLocation, String dropLocation) {
